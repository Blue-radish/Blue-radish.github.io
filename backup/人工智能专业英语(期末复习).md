...
### 翻译
我叫xxx，目前是HIT的一名本科生，专业是人工智能。我的成绩在专业中排名前15%。在学习过程中，我修读了计算机网络、深度学习和机器学习等重要课程，这些课程为我打下了坚实的技术基础。我熟练掌握Python、PyTorch、C/C++和Shell，并且在Linux环境下也有丰富的工作经验。
我曾多次参加国家级竞赛，并获得了两个二等奖和若干三等奖。例如，在iCAN大赛中，我开发了一个基于视觉的产品检测系统，主要负责其中的视觉算法开发。在另一个项目中，我开发了一个基于BERT和ResNet的多模态假新闻检测系统。
此外，我还参与了一篇发表在《电子学报》上的SCI论文，负责实验和部分写作工作。
